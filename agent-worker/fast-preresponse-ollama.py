...
class PreResponseAgent(Agent):
    def __init__(self):
        super().__init__(
            ...
            llm=openai.LLM.with_ollama(model="llama3.2:latest",base_url="http://localhost:11434/v1"),
        )
        self._fast_llm = openai.LLM.with_ollama(model="llama3.2:1b", base_url="http://localhost:11434/v1")
